...
/**
 * Checkout Counter - the main checkout GUI block with 27 slots
 * for processing transactions.
 * <p>
 * This block serves as the primary workstation for store checkout operations.
 * It supports horizontal facing placement (opposite to player), waterlogging,
 * custom collision and outline shapes, and automatic inventory scattering
 ...
 */
public class CheckoutCounterBlock extends BlockWithEntity {
    ...
    /**
     * Constructs a new CheckoutCounterBlock with the given settings.
     * Default state: facing NORTH, not waterlogged.
     *
     * @param settings the block settings (material, hardness, etc.)
     */
    public CheckoutCounterBlock(Settings settings) {
        super(settings);
    ...
    /**
     * Creates the block entity for this checkout counter.
     *
     * @param pos   the position of the block
     * @param state the current block state
     * @return a new CheckoutCounterBlockEntity instance
     */
    @Override
    ...
    protected MapCodec<? extends BlockWithEntity> getCodec() {
        return createCodec(CheckoutCounterBlock::new);
    }
}
