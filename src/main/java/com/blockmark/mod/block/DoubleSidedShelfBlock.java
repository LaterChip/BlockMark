 ...
 *   <li><b>Inventory:</b> 36 slots, dropped on removal</li>
 * </ul>
 *
 * @see WallShelfBlockEntity
 */
public class DoubleSidedShelfBlock extends BlockWithEntity {
    ...
    /**
     * Constructs a new DoubleSidedShelfBlock with the given settings.
    ...
    protected MapCodec<? extends BlockWithEntity> getCodec() {
        return createCodec(DoubleSidedShelfBlock::new);
    }
}
