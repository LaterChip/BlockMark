 ...
 * Beverage Cooler
 * <p>
 * This is a refrigerated display block with a visual luminance effect.
 * It supports horizontal facing for placement orientation, waterlogging for
 * submerged placement, a lit state indicator, custom collision and outline
 * shapes, and automatic inventory item scattering on block removal.
 * </p>
 *
 * <ul>
 *   <li><b>Facing:</b> Determined by player placement direction (opposite)</li>
 *   <li><b>Lit:</b> Indicates whether the unit is actively lit (visual only)</li>
 ...
 */
public class BeverageCoolerBlock extends BlockWithEntity {
    /** The direction this block faces horizontally. */
    public static final DirectionProperty FACING = Properties.HORIZONTAL_FACING;

    /** Whether this refrigerated unit is lit. */
    ...
    /**
     * Constructs a new BeverageCoolerBlock with the given settings.
     * Default state: facing NORTH, not lit, not waterlogged.
     *
     * @param settings the block settings (material, hardness, luminance, etc.)
     */
    public BeverageCoolerBlock(Settings settings) {
        super(settings);
     ...
     * Includes facing, lit status, and waterlogging.
     *
    ...
    protected MapCodec<? extends BlockWithEntity> getCodec() {
        return createCodec(BeverageCoolerBlock::new);
    }
}
