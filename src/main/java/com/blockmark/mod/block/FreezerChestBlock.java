 ...
 */
public class FreezerChestBlock extends BlockWithEntity {
    ...
    protected MapCodec<? extends BlockWithEntity> getCodec() {
        return createCodec(FreezerChestBlock::new);
    }
}
