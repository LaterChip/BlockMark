 ...
 */
public class OpenCoolerBlock extends BlockWithEntity {
    ...
    protected MapCodec<? extends BlockWithEntity> getCodec() {
        return createCodec(OpenCoolerBlock::new);
    }
}
