 ...
 */
public class HeavyDutyShelfBlock extends BlockWithEntity {
    ...
    /**
     * Constructs a new HeavyDutyShelfBlock with the given settings.
     * Default state: facing NORTH, not waterlogged.
     *
     * @param settings the block settings (material, hardness, etc.)
     */
    public HeavyDutyShelfBlock(Settings settings) {
        super(settings);
    ...
    protected MapCodec<? extends BlockWithEntity> getCodec() {
        return createCodec(HeavyDutyShelfBlock::new);
    }
}
