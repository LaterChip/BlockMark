 ...
 *   <li><b>Inventory:</b> 9 slots, dropped on removal</li>
 * </ul>
 *
 * @see WallShelfBlockEntity
 */
public class WallMountShelfBlock extends BlockWithEntity {
    ...
    /**
     * Constructs a new WallMountShelfBlock with the given settings.
     * Default state: facing NORTH, not waterlogged.
     *
     * @param settings the block settings (material, hardness, etc.)
     */
    public WallMountShelfBlock(Settings settings) {
        super(settings);
    ...
    protected MapCodec<? extends BlockWithEntity> getCodec() {
        return createCodec(WallMountShelfBlock::new);
    }
}
