 ...
 */
public class EndCapShelfBlock extends BlockWithEntity {
    ...
    /**
     * Constructs a new EndCapShelfBlock with the given settings.
     * Default state: facing NORTH, not waterlogged.
     *
     * @param settings the block settings (material, hardness, etc.)
     */
    public EndCapShelfBlock(Settings settings) {
        super(settings);
    ...
    protected MapCodec<? extends BlockWithEntity> getCodec() {
        return createCodec(EndCapShelfBlock::new);
    }
}
