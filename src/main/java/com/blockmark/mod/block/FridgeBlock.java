 ...
 *   <li><b>Inventory:</b> 54 slots, dropped on removal</li>
 * </ul>
 *
 * @see WallShelfBlockEntity
 */
public class FridgeBlock extends BlockWithEntity {
    ...
    /**
     * Constructs a new FridgeBlock with the given settings.
    ...
    protected MapCodec<? extends BlockWithEntity> getCodec() {
        return createCodec(FridgeBlock::new);
    }
}
