...
/**
 * Handled screen for the Glass Cabinet block - a glass-front display
 * unit for potions and rare items with 27 slots and a subtle luminance
 * effect. Features keyboard hotbar shortcuts and shift-scroll quick-move.
 */
public class GlassCabinetScreen extends HandledScreen<WallShelfScreenHandler> {
    private static final Identifier TEXTURE = BlockMarkMod.id("textures/gui/glass_cabinet.png");
    private static final int INVENTORY_ROWS = 3;
    private static final int INVENTORY_COLS = 9;

    public GlassCabinetScreen(WallShelfScreenHandler handler, PlayerInventory inventory, Text title) {
