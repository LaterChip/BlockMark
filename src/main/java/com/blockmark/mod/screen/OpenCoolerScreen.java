...
/**
 * Handled screen for the Open Cooler block - an open-top refrigerated
 * display unit with 18 slots. Features keyboard hotbar shortcuts,
 * shift-scroll for quick item transfer, and standard close keys.
 */
public class OpenCoolerScreen extends HandledScreen<WallShelfScreenHandler> {
    private static final Identifier TEXTURE = BlockMarkMod.id("textures/gui/open_cooler.png");
    private static final int INVENTORY_ROWS = 3;
    private static final int INVENTORY_COLS = 9;

    public OpenCoolerScreen(WallShelfScreenHandler handler, PlayerInventory inventory, Text title) {
