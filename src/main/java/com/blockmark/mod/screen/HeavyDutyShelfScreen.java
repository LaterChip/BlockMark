...
/**
 * Handled screen for the Heavy Duty Shelf block - a metal industrial
 * shelf with 54 slots. Supports number-key hotbar quick-access,
 * shift-scroll slot cycling for rapid item transfer, and ESC/E key close.
 */
public class HeavyDutyShelfScreen extends HandledScreen<WallShelfScreenHandler> {
    private static final Identifier TEXTURE = BlockMarkMod.id("textures/gui/heavy_duty_shelf.png");
    private static final int INVENTORY_ROWS = 3;
    private static final int INVENTORY_COLS = 9;

    public HeavyDutyShelfScreen(WallShelfScreenHandler handler, PlayerInventory inventory, Text title) {
