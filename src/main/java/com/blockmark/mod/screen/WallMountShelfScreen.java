 ...
 */
public class WallMountShelfScreen extends HandledScreen<WallShelfScreenHandler> {
    private static final Identifier TEXTURE = BlockMarkMod.id("textures/gui/wall_mount_shelf.png");
    private static final int INVENTORY_ROWS = 3;
    private static final int INVENTORY_COLS = 9;

    public WallMountShelfScreen(WallShelfScreenHandler handler, PlayerInventory inventory, Text title) {
