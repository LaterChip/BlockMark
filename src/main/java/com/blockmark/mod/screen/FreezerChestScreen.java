...
/**
 * Handled screen for the Freezer Chest block.
 * A chest-style freezer unit with 27 cold storage slots.
 * Includes keyboard number-key shortcuts, ESC close,
 * and shift-scroll quick-move support.
 */
public class FreezerChestScreen extends HandledScreen<WallShelfScreenHandler> {
    private static final Identifier TEXTURE = BlockMarkMod.id("textures/gui/freezer_chest.png");
    private static final int INVENTORY_ROWS = 3;
    private static final int INVENTORY_COLS = 9;

    public FreezerChestScreen(WallShelfScreenHandler handler, PlayerInventory inventory, Text title) {
