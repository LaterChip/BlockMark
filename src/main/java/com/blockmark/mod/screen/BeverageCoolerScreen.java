...
/**
 * Handled screen for the Beverage Cooler block - a refrigerated glass-door
 * display unit with 27 inventory slots. Supports keyboard hotbar shortcuts
 * (number keys 1-9), mouse scroll-based slot cycling, and inventory key toggle.
 */
public class BeverageCoolerScreen extends HandledScreen<WallShelfScreenHandler> {
    private static final Identifier TEXTURE = BlockMarkMod.id("textures/gui/beverage_cooler.png");
    private static final int INVENTORY_ROWS = 3;
    private static final int INVENTORY_COLS = 9;

    public BeverageCoolerScreen(WallShelfScreenHandler handler, PlayerInventory inventory, Text title) {
