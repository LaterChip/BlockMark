...
/**
 * Handled screen for the Double Sided Shelf block.
 * Provides 27-slot inventory GUI accessible from both block faces,
 * with number-key hotbar shortcuts and shift-scroll quick-move.
 */
public class DoubleSidedShelfScreen extends HandledScreen<WallShelfScreenHandler> {
    private static final Identifier TEXTURE = BlockMarkMod.id("textures/gui/double_sided_shelf.png");
    private static final int INVENTORY_ROWS = 3;
    private static final int INVENTORY_COLS = 9;

    public DoubleSidedShelfScreen(WallShelfScreenHandler handler, PlayerInventory inventory, Text title) {
