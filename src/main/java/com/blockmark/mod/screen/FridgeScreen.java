...
/**
 * Handled screen for the Fridge block - a double-door refrigerator
 * with 54 slots and luminance. Supports keyboard hotbar shortcuts,
 * shift-scroll quick-move, and ESC / inventory key close.
 */
public class FridgeScreen extends HandledScreen<WallShelfScreenHandler> {
    private static final Identifier TEXTURE = BlockMarkMod.id("textures/gui/fridge.png");
    private static final int INVENTORY_ROWS = 3;
    private static final int INVENTORY_COLS = 9;

    public FridgeScreen(WallShelfScreenHandler handler, PlayerInventory inventory, Text title) {
