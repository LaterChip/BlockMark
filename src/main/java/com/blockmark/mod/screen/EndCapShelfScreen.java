...
/**
 * Handled screen for the End Cap Shelf - a promotional display shelf
 * with 27 slots. Supports number-key hotbar quick-swap, shift-scroll
 * for item quick-move, and ESC / E key to close.
 */
public class EndCapShelfScreen extends HandledScreen<WallShelfScreenHandler> {
    private static final Identifier TEXTURE = BlockMarkMod.id("textures/gui/end_cap_shelf.png");
    private static final int INVENTORY_ROWS = 3;
    private static final int INVENTORY_COLS = 9;

    public EndCapShelfScreen(WallShelfScreenHandler handler, PlayerInventory inventory, Text title) {
