...
/**
 * Handled screen for the Storage Crate block - a small 9-slot
 * storage container. Features keyboard hotbar shortcuts,
 * shift-scroll quick-move, and ESC / inventory key close.
 */
public class StorageCrateScreen extends HandledScreen<WallShelfScreenHandler> {
    private static final Identifier TEXTURE = BlockMarkMod.id("textures/gui/storage_crate.png");
    private static final int INVENTORY_ROWS = 3;
    private static final int INVENTORY_COLS = 9;

    public StorageCrateScreen(WallShelfScreenHandler handler, PlayerInventory inventory, Text title) {
