...
/**
 * Handled screen for the Vending Machine block - an illuminated
 * automated vendor unit with 27 slots. Supports number-key hotbar
 * quick-access, shift-scroll slot cycling, and standard close keys.
 */
public class VendingMachineScreen extends HandledScreen<WallShelfScreenHandler> {
    private static final Identifier TEXTURE = BlockMarkMod.id("textures/gui/vending_machine.png");
    private static final int INVENTORY_ROWS = 3;
    private static final int INVENTORY_COLS = 9;

    public VendingMachineScreen(WallShelfScreenHandler handler, PlayerInventory inventory, Text title) {
