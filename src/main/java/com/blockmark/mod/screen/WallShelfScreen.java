...
/**
 * Handled screen for the Wall Shelf block - the primary shelving unit
 * with 27 slots. Supports keyboard hotbar shortcuts (number keys 1-9),
 * shift-scroll quick-move for rapid item transfer, and ESC/E close.
 */
public class WallShelfScreen extends HandledScreen<WallShelfScreenHandler> {
    private static final Identifier TEXTURE = BlockMarkMod.id("textures/gui/wall_shelf.png");
    private static final int INVENTORY_ROWS = 3;
    private static final int INVENTORY_COLS = 9;

    public WallShelfScreen(WallShelfScreenHandler handler, PlayerInventory inventory, Text title) {
